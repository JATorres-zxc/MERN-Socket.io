		...
		<div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
            <div className='w-full p-6 rounded-lg shadow-md bg-gray-900'>
				...
				<form onSubmit={handleSubmit}>
					...
					<Link to='/signup' className='text-sm  hover:underline hover:text-blue-500 mt-4 inline-block text-gray-300'>
						{"Don't"} have an account?
					</Link>

					<div>
						<button className='btn btn-block btn-sm mt-4 text-gray-300'
							disabled={loading}
